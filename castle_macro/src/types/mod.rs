...
pub fn derive_type(item_impl: Item) -> proc_macro2::TokenStream {
    ...
    let (self_name, field_definitions, items): (syn::Ident, Vec<syn::Expr>, Vec<syn::Item>) = match item_impl {
        Item::Impl(mut item_impl) => {
            ...
            (
                ...
                [
                    ...
                    syn::parse_quote_spanned!{ item_impl.span() =>
        ...
        _ => panic!("Only impls are supported"),
    };
