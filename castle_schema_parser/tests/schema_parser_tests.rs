...
//     Input, InputDefinition, InputTypeDefinition, Kind, Number, Primitive, SchemaDefinition,
//     TypeDefinition, VariantDefinition, VariantKindDefinition,
// };
...
//                                 inputs: [(
//                                     "baz".into(),
//                                     Input::Primitive(Primitive::Number(Number::from(123))),
//                                 )]
//                                 .into(),
//                             },
//                             AppliedDirective {
